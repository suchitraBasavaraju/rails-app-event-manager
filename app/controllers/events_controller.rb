class EventsController < ApplicationController
  ...
  def create_event_a
    ...
    event_a_response = @iterable_service.web_push_event("Event A", current_user.email)
  ...
  def create_event_b
    ...
    event_a_response = @iterable_service.web_push_event("Event B", current_user.email)
